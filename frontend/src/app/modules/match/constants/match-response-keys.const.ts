...
export const MATCH_SCORE_NAME_KEYS: readonly (keyof Pick<
  MatchScoreItem,
  'name' | 'candidateName' | 'applicantName'
>)[] = ['name', 'candidateName', 'applicantName'];

/** First present field wins (same precedence as prior `??` chain). */
export const MATCH_SCORE_PRIMARY_VALUE_KEYS: readonly (keyof Pick<
  MatchScoreItem,
...
export const MATCH_SCORE_RECOMMENDATION_TEXT_KEYS: readonly (keyof Pick<
  MatchScoreItem,
