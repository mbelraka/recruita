...
/** Applicant API user-facing messages (`recruita.api.applicant-messages`). */
public class ApplicantApiMessageProperties {
  ...
  @NotBlank private String applicationStatusRequired = "Applicant application status is required.";

  @NotBlank private String currentJobTitleRequired = "Applicant current job title is required.";

  @NotBlank private String yearsOfExperienceRequired = "Applicant years of experience is required.";

  @NotBlank private String skillsRequired = "Applicant must include at least one skill.";
  @NotBlank private String idMismatch = "Applicant id in the request body must match the path id.";
